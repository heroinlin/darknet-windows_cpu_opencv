...
float train_network_datum_gpu(network net, float *x, float *y)
{
	...
	//printf("x_size=%d\n",x_size);//debuging 1通道=256*256*1*32=2097152.三通道=256*256*3*32=6291456.
    int y_size = get_network_output_size(net)*net.batch;
	//printf("y_size=%d\n", y_size);//debuging 1通道=539*32=17248.三通道=539*32=17248.
	...
	//每net.bacth*net.subdivisions=bacth=64(cfg文件中的batch值)次，更新一次网络
