...
typedef enum {
	CLASSIFICATION_DATA, DETECTION_DATA, CAPTCHA_DATA, REGION_DATA, REGION_DATA_GRAY, IMAGE_DATA, COMPARE_DATA, WRITING_DATA, SWAG_DATA, TAG_DATA, OLD_CLASSIFICATION_DATA
} data_type;
